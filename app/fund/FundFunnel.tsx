      ...
      >
        ...
        {complete ? (
          ...
          <div className="contribute-choice">
            ...
            {copied === "zelle" && (
              <p className="cc-zelle-hint" aria-live="polite">
                Open your banking app and paste it in Zelle to send.
              </p>
            )}
            <button className="cc-btn cc-card" onClick={() => setMethod("card")}>
              Pay with your card
            </button>
          </div>
        )}
...
.cc-venmo, .cc-zelle { position: relative; }
...
.cc-zelle-hint { margin: -2px 0 12px; text-align: center; font-size: 15px; line-height: 1.5; font-weight: 600; color: #6D1ED4; }
